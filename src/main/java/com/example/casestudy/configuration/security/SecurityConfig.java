package com.example.casestudy.configuration.security;

import com.example.casestudy.configuration.custom.CustomAccessDeniedHandler;
import com.example.casestudy.configuration.custom.RestAuthenticationEntryPoint;
import com.example.casestudy.configuration.filter.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/", "/login","/signup","/singers","/**").permitAll()
